...
echo "***************************************************************************************************************************************************"
echo "  "
echo "  🚀 Starting installation - Launching Ansible Playbook 10_install-cp4waiops_ai_manager_only_with_demo_runbooks.yaml"
echo "  "
echo "***************************************************************************************************************************************************"

cd ansible
ansible-playbook -e ENTITLED_REGISTRY_KEY=$ENTITLED_REGISTRY_KEY 10_install-cp4waiops_ai_manager_only_with_demo_runbooks.yaml $VERBOSE
cd -
