...
do
      ...
      echo "*****************************************************************************************************************************"
      echo "  "
      echo "  🐥 CloudPak for Watson AIOps v3.3 - Follow Install"
      echo "  "
      echo "*****************************************************************************************************************************"
      ...
      echo "    📥 Number of Pods:     $NUM_PODS_MP                                     "
      echo "    ❗ Pods Not Ready:                                     "
      ...
      echo "  "
      echo "*****************************************************************************************************************************"
      echo "  🐥 Namespace: ibm-common-services"
      echo "    📥 Number of Pods:     $NUM_PODS_COM      (should be around 35 when done)                               "
      echo "    ❗ Pods Not Ready:                                     "
      ...
      echo "    📥 Number of Pods:     $NUM_PODS_WAI      (should be around 125 when done)                                       "
      echo "    ❗ Pods Not Ready:                                     "
      ...
      if [[ ! $ERROR_AKORA == "0" ]]; then
            ...
            echo "  "
                  echo "  "
            echo "*****************************************************************************************************************************"
            echo "  🐥 Easy Install Debug"
            echo "*****************************************************************************************************************************"
            echo "  "
            echo "  ❗ Your install seems to be hitting a known problem: https://ibm-cloud.slack.com/archives/C019D1Z89R6/p1645631170165839?thread_ts=1645631030.273159&cid=C019D1Z89R6"
